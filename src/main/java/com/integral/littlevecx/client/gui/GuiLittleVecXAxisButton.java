...
public class GuiLittleVecXAxisButton extends SubGuiDialogAxis.GuiAxisButton {
    ...
    public GuiLittleVecXAxisButton(String name, String caption, int x, int y, int width, int height, LittleGridContext context, int[] initialAxisData,
            AnimationGuiHandler handler) {
        super(name, caption, x, y, width, height, context, null, handler);
        this.axisData = initialAxisData;
    ...
    public void onClicked(int x, int y, int button) {
        ...
        SubGuiLittleVecXAxis dialog = new SubGuiLittleVecXAxis(this);
        SubGui owner = getGui();
    ...
    @SideOnly(Side.CLIENT)
    public static class SubGuiLittleVecXAxis extends SubGui {

        public final GuiLittleVecXAxisButton activator;

        public SubGuiLittleVecXAxis(GuiLittleVecXAxisButton activator) {
            super(160, 130);
        ...
        public void createControls() {
            ...
            addControl(new GuiButton("close", 125, 110) {
                ...
                public void onClicked(int x, int y, int button) {
                    ...
                    onClosed();
                    gui.removeLayer(SubGuiLittleVecXAxis.this);
                }
            });
        }
